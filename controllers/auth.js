...
exports.register = async (req, res) => {
    try {
        ...
        const user = await User.findOne({$or:[{Email: req.body.Email}, {Login: req.body.Login}]});
...
async function sendVerificationEmail(user, req, res){
    try
    {
        ...
        let html = `<h1>Get Ready To Get Trading.</h1>
                    <p>Hello, ${user.Login}! Congratulations! You are on your way to get verified. Please click on the <a href="${link}">link</a> to go verify your account.</p> 
